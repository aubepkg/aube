---
description: "Fetch a package into a throwaway environment and run its binary"
editLink: false
---
...
```sh
aubx cowsay hi
aubx --package create-vite create-vite my-app
```

Read the [workflow guide](/package-manager/scripts) for context.
