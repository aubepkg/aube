...
pub(crate) use settings_context::{
    ...
    embedder_node_executable, ensure_registry_auth_for_package, expand_setting_path,
    ...
    load_npm_config, lockfile_kind_for_write, lockfile_kind_for_write_with_ctx, make_client,
    metadata_cache_anchor, open_store, open_store_for_maintenance, open_store_with_ctx,
