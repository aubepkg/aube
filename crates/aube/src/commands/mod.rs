...
pub(crate) use settings_context::{
    ...
    resolve_virtual_store_dir_max_length_for_cwd, resolved_cache_dir, resolved_cache_dir_with_ctx,
    resolved_store_dir, resolved_store_dir_with_ctx, run_pnpmfile_pre_resolution,
    scope_embedder_install_overrides, set_fetch_cli_overrides, set_global_frozen_override,
